...
\begin{frame}[fragile]
  \begin{block}{}
    \begin{itemize}
      ...
      \item need for alternative containers
...
\begin{frame}[fragile]
  \frametitle{{\em In-memory data} vs {\em on-disk data}}
  \begin{block}{}
    {\bf Examples of in-memory containers}
    \begin{itemize}
      \item {\bf dgCMatrix} objects from the Matrix package: sparse integer
            matrix representation
      \item {\bf RleArray} and {\bf RleMatrix} objects from the DelayedArray
            package: uses RLE compression; arbitrary number of dimensions;
            supports integer, double, logical, complex, character, and raw
            types
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{{\em In-memory data} vs {\em on-disk data}}
  \begin{block}{}
    {\bf Examples of on-disk containers}
    \begin{itemize}
      \item {\bf HDF5 files}: direct manipulation via low-level API provided
            by the rhdf5 package
      \item {\bf HDF5Array} and {\bf HDF5Matrix} objects from the HDF5Array
            package: high level containers that provide most of the standard
            R matrix/array API 
    \end{itemize}
  \end{block}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{HDF5Array and HDF5Matrix objects}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{RleArray and RleMatrix objects}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
