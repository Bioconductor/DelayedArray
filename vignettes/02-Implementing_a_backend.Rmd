...
The rest of this documents covers the above topics in greater details.
Some famliarity with writing R packages is assumed. Don't hesitate to
look at the source of the _HDF5Array_ package for a real example of
DelayedArray on-disk backend implementation.
